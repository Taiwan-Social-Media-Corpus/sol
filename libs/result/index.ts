...
type ErrorUnion<T extends readonly Result<unknown, unknown>[]> = T extends readonly Result<
  unknown,
  infer E
>[]
  ? E
...
export const Result = {
  ...
  all<T extends Result<unknown, unknown>[] | []>(results: T): Result<OkTuple<T>, ErrorUnion<T>> {
